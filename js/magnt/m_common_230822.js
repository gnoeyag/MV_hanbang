    ...
    handler: {
      ...
      winScroll: function() {
        ...
        if (anchor.length > 0) {
          ...
          //2023.08.21
          //anchor.find('.li>a') -> anchor.find('.tabType02>li>a')
          anchor.find('.tabType02>li>a').each(function(idx) {
            var $this = $(this);
    ...
    bind: function() {
      ...
      $(common.selector.header).each(function() {
        ...
        head.find('.menuScrollArea').scroll(function() {
          ...
          if (scrollTop > 0 && !head.hasClass('navFixed')) {
            head.addClass('navFixed');
          } else if (scrollTop === 0 && head.hasClass('navFixed')) {
      ...
      //2023.08.22
      //[매매/전세/월세/연세] 버튼 클릭 시 하단 매물리스트 영역으로 스크롤
