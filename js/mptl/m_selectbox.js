      ...
      if (select.data("selectBox")) {
        ...
        var opt = {
          ...
          select: function (event, ui) {
            ...
            // 컨텐츠 선택 시 클래스 추가
						var button = select.closest(".selectWrap");
						//var focusbutton = select.closest(".selectWrap").parent();
						button.addClass("selectON");
							//focusbutton.addClass("selectON");
          ...
          close: function () {
            ...
            if (front.next('.dimmed2').length > 0) {
              ...
              select
              .closest(".selectWrap").removeClass('active');
            ...
            //2023.11.28
            //select menu 열릴 때 overflow style 제거
            if (front.closest(".wrapper").length > 0) {
              front.closest(".wrapper").css("overflow", "");
            }
          },
          ...
          open: function () {
            ...
            if (front.next('.dimmed2').length > 0) {
              ...
              //2023.08.21
              //특정 페이지 dimmed 위치 수정
              if(this.closest('.anchorTabFixed') !== null) {
                select
                .closest(".selectWrap").addClass('active');

                // $('.dimmed').insertAfter(front);
            ...
            //parent.addClass("selectWrapON")
            if (front.closest(".layContainer").length > 0) {
              front.closest(".layContainer").css("overflow", "hidden");
            }

            //2023.11.28
            //select menu 열릴 때 overflow hidden
            if (front.closest(".wrapper").length > 0) {
              front.closest(".wrapper").css("overflow", "hidden");
            }
            ...
            //2023.11.28
            //scroll area max-height 값 추가
            scrollArea.css("max-height", front.closest('.wrapper').height() - 104);
            scrollArea.css("max-height", front.closest('.layPop').height() - 104);
        ...
        //2023.08.21
        //selected 상태의 selectWrap에 selectON 클래스 추가
        select.children().each(function(idx, el) {
          if($(el).attr('selected') && !$(el).attr('hidden')) {
            $(el.closest('.selectWrap')).addClass('selectON')
          }
        })
